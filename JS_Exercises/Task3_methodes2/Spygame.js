 ...
 */
 export function canExecuteFastAttack(knightIsAwake) {
    ...
    export function canSpy(knightIsAwake, archerIsAwake, prisonerIsAwake) {
      if (knightIsAwake === false && prisonerIsAwake === false && archerIsAwake === true) {
        return true
      } else if (knightIsAwake === false && prisonerIsAwake === true && archerIsAwake != true){
        return true
      } else if (knightIsAwake === true && prisonerIsAwake === false && archerIsAwake != true) {
        return true
      } else if (knightIsAwake === false && prisonerIsAwake === true && archerIsAwake != true) {
        return true
      } else if (knightIsAwake === false && prisonerIsAwake === true && archerIsAwake === true) {
        return true
      } else if (knightIsAwake === true && prisonerIsAwake === true && archerIsAwake != true){
        return true
      } else if (knightIsAwake === true && prisonerIsAwake === true && archerIsAwake === true) {
        return true
      } else {
